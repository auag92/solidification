void mult_solve(double *y,double *f)
{
	...
	for( ; ; ) //I can break out of this loop under a particular situation 
	{
		...
		//============================================================================//
		//setting up the boundary conditions for all the grids (see "set_boundary.c")
		//the finest grid will have specified flux boundary condition 
		//the coarser grids will have dirichlet boundary conditions set to zero
		
		boundary(y,mesh_tracker);
		//==========================================================================//		
		...
		printf("tot_iter=%d\titer=%d\terror=%.12lf\n",tot_iter,iter,error);
