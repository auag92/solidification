//weighted red-black gauss-seidel solver for u''=f(x,y) over the domain 0<x<1,0<y<1 with dirichlet bondary conditions all around
...
#define POINT_SOURCE_MAGNITUDE 1000.0//the magnitud of the point source
...
double g_s_prefac,sq_dx_times_sq_dy,sq_dx,sq_dy;
