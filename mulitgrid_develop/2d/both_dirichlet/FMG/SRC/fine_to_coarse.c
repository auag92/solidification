void ftoc(double *y,double *f,int mesh_tracker)
{
	...
	{ 
		for(i=1;i<=nodes[coarser_mesh_tracker].x-2;i++)	
		{
			...
			res_2i_2j=comp_res(y,f,mesh_tracker,temp_x,temp_y);	
			...
			res_2i_min_1_2j=comp_res(y,f,mesh_tracker,temp_x,temp_y);	
			...
			res_2i_plus_1_2j=comp_res(y,f,mesh_tracker,temp_x,temp_y);	
			...
			res_2i_2j_min_1=comp_res(y,f,mesh_tracker,temp_x,temp_y);	
			...
			res_2i_min_1_2j_min_1=comp_res(y,f,mesh_tracker,temp_x,temp_y);	
			...
			res_2i_plus_1_2j_min_1=comp_res(y,f,mesh_tracker,temp_x,temp_y);
			...
			res_2i_2j_plus_1=comp_res(y,f,mesh_tracker,temp_x,temp_y);	
			...
			res_2i_min_1_2j_plus_1=comp_res(y,f,mesh_tracker,temp_x,temp_y);	
			...
			res_2i_plus_1_2j_plus_1=comp_res(y,f,mesh_tracker,temp_x,temp_y);
