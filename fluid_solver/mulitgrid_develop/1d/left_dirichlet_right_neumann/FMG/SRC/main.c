...
//weighted red-black gauss-seidel solver for y''=f(x) over the domain 0<x<1 with Dirichlet at x=0 and Neumann bondary condition at x=1
...
#define LEFT 100.0 //it denotes the value of the dependent variable at the left boundary  
#define RIGHT 0.0//it denotes the value of the first derivative of the dependent variable at the left boundary 
