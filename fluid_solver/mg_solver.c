...
#define POINT_SOURCE_MAGNITUDE 10.0//the magnitud of the point source
...
double g_s_prefac[NO_OF_LEVELS],sq_dx_times_sq_dy[NO_OF_LEVELS],sq_dx[NO_OF_LEVELS],sq_dy[NO_OF_LEVELS];//some quantities that are required by the gausss-seidel solver
